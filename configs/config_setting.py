...
class setting_config:
    ...
    criterion = BCELoss()
    visual_imgs = True  # True: Write the image to the folder and ensure that the label after data augmentation is correct
    load_size = 512
    num_classes = 1
    input_channels = 3
    distributed = False
    ...
    log_dir = "log"
    resume_model = ""  # restore training from checkpoint
    modelsSavePath = "checkpoints"
    print_interval = 10
    val_interval = 20
    save_interval = 20
    threshold = 0.5
